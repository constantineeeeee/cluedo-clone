...
public class HardMainBoardDrawingPanel extends JPanel{
	...
	static BufferedImage xScarlett, xMustard, xWhite, xPlum, xGreen;
	static BufferedImage scarlettImage, mustardImage, whiteImage, plumImage, greenImage;
	...
	public HardMainBoardDrawingPanel() {
		...
		try {
			...
			xPlum		= ImageIO.read(this.getClass().getResource("eliminatedPlum.png"));
			xGreen 		= ImageIO.read(this.getClass().getResource("eliminatedGreen.png"));
	...
	static void setPlumImage(BufferedImage image) {
		plumImage = image;
	}
	static void setGreenImage(BufferedImage image) {
		greenImage = image;
	}
	...
	public void paintComponent(Graphics g) {
		...
		setPlumImage(plumImage);
		g.drawImage(plumImage, startX + picWidth + space, startY + picHeight/2 + space*2 + picHeight, picWidth, picHeight, this);
		
		setGreenImage(greenImage);
		g.drawImage(greenImage, startX, startY + (picHeight+space)*2 , picWidth, picHeight, this);
