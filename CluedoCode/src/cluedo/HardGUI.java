...
public class HardGUI implements MouseListener, MouseMotionListener{
	private static JFrame frame;
	private HardMainBoardDrawingPanel drawingPanel;
	
	private int width = 1280, height = 768;
	
	private MusicHandling music;
	...
	public HardGUI() {
		...
		music.setFile(getBgMusic());
		music.playLoop();
		initializeUI();
		
		System.out.println("DIFFICULTY: " + MainMenuScreen.difficulty + "KILL COUNT: " + GameRun.killCount);
	...
	public void initializeUI() {
		...
		drawingPanel = new HardMainBoardDrawingPanel();
